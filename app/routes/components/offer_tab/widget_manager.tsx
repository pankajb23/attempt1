...
import { OfferType } from './offer_types_util';
...
const widgets = [
    {
        ...
        grps: "Product",
        offerType: OfferType.FrequentlyBoughtTogether,
    },
    {
        id: "2",
        ...
        grps: "Product",
        offerType: OfferType.ProductsAddOn,
    },
    {
        id: "3",
    ...
    },
    {
        ...
        grps: "Cart",
        offerType: OfferType.CartUpAndDownSell,
    },
    {
        id: "5",
        ...
        grps: "Post",
        offerType: OfferType.PostPurchaseUpSell,
    },
    {
        id: "6",
        ...
        grps: "Post",
        offerType: OfferType.ThankUAddOn,
    }
]
...
export default function WidgetManager({ filter, onShowOfferPage }) {
                ...
                <InlineStack key={index} wrap={false} gap='300' direction={'row'} >
                    {widgets.map((w) => (
                        <OfferWidget
                            ...
                            img={w.img}
                            key={w.id}
                            onShowOfferPage={onShowOfferPage}
