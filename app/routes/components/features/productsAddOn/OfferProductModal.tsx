            ...
            <>
                <div style={{ marginTop: "10px" }}>
                    <Controller
                        ...
                        (<Select
                            label={<Text as="h5" variant="headingSm">Maximum number of add-ons that can be selected</Text>}
                            options={[
                                { label: "Select any number of add-ons", value: "anyNumberOfAddOns" },
                                { label: "Select atleast one add-on", value: "atleastOneAddOn" },
                                { label: "Select a maximum of one add-on", value: "maximumOneAddOn" }
                            ]}
                            value={value}
                            onChange={onChange}
                        />
                ...
                <div style={{ marginTop: "10px" }}>
                    <Controller
                        ...
                        render={({ field: { onChange, value } }) => (
                            <Checkbox
                                label={<Text as="h5" variant="headingSm">Randomize order each time</Text>}
                                checked={value}
                                onChange={onChange}
                                helpText={<Text as="dd" variant="bodySm" tone="subdued">Order of products will be shuffled randomly.</Text>}
                            />
                        )}
                    />
                </div>
