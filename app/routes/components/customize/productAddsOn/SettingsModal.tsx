...
function WidgetButtonType() {
    ...
    return (
        <Controller
            ...
            render={({ field: { value, onChange } }) => (
                <Select
                    label={<Text as="p" variant="bodySm" fontWeight="bold">Widget button type</Text>}
                    options={layoutStyleOptions}
                    value={value}
                    onChange={onChange}
                    helpText={(() => {
...
function OfferProductClickAction() {
    ...
    const layoutStyleOptions = [
        ...
        { label: "Custom Open product page in new tab", value: "openProductPageNewTab" },
    ]
    ...
    return (
        <>
            {shouldShowOffProductclickAction && <Controller
                control={control}
    ...
    return (<>
        {
            shouldShowOffProductclickAction && <Controller
                ...
                render={({ field: { value, onChange } }) => (
                    <Checkbox
                        label={<Text as="p" variant="bodySm" fontWeight="bold">Apply discount when trigger product is also bought</Text>}
                        checked={value}
                        onChange={onChange}
                    />
                )}
...
function DisableWidgetAddOns() {
    ...
    return (
        <Controller
            ...
            render={({ field: { value, onChange } }) => (
                <Checkbox
                    label={<Text as="p" variant="bodySm" fontWeight="bold">Disable widget add-ons</Text>}
                    checked={value}
                    onChange={onChange}
                />
            )}
