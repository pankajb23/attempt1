    ...
    return (
        <Controller
            ...
            render={({ field: { value, onChange } }) => (
                <Select
                    label={<Text as="p" variant="bodySm" fontWeight="bold">Title font weight</Text>}
                    value={value}
                    onChange={onChange}
                    options={options}
                />
        ...
        <Controller
            ...
            render={({ field: { value, onChange } }) => (
                <TextField
                    ...
                    onChange={onChange}
                    label={<Text as="p" variant="bodySm"> {heading}</Text>}
                    autoComplete="off"
                />
            )}
        />
...
function FullWidthWidgetCheckbox() {
    ...
    return (
        <Controller
            ...
            render={({ field: { value, onChange } }) => (
                <Checkbox
                    label={<Text as="p" variant="bodySm" fontWeight="bold">Make widget full width</Text>}
                    checked={value}
                    onChange={onChange}
                />
            )}
...
export default function StylingModal() {
    ...
    return (
        <Card roundedAbove="sm">
            <BlockStack gap="200">
                <Text as="p" variant="bodySm" fontWeight="bold"> Styling</Text>
