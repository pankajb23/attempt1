      ...
      <>
        <Layout.Section>
          <FormProvider {...methods}>
            <BlockStack>
              <TopHeadingBanner navigateTo={navigateTo} heading="Products Add-On" saveOfferButton={true} onSave={methods.handleSubmit(onSubmit)} />
            </BlockStack>
                ...
                <Layout>
                  ...
                  <Layout.Section variant="oneThird">
                    <SideModal
                      ...
                      explanation={'Product add-ons are displayed with checkboxes above the Add to Cart button.'}
