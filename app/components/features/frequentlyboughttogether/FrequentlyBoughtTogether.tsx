...
function ToggleModal() {
    ...
    return (
        <div style={{ marginBottom: '20px' }}>
            <Card>
                <BlockStack gap="200">
                    <Text as="h6" fontWeight="bold" >Offer is currently {defaultValue} mode</Text>
                    <div>
                        <Controller
                            name="status"
                            control={control}
...
export default function FrequentlyBoughtTogether({ navigateTo, offer = null }) {
    ...
    const onError = (errors) => {
        ...
        shopify.toast.show(`Failed to save offer ${errors.offerName.message}`, { duration: 2000, isError: true });
    };
