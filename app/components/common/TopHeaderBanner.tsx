...
export default function TopHeadingBanner({ navigateTo, heading, saveOfferButton, onSave, saveButtonContent = undefined, mainPage = NavigationPage.MAIN_PAGE }: TopHeadingBannerProps) {
    ...
    const offerStatusBadge = statusTones[offerStatus] ? (
        <Badge tone={statusTones[offerStatus].tone}>{statusTones[offerStatus].label}</Badge>
    ) : null;
            ...
            <InlineStack gap="300" wrap={false}>
                ...
                <div style={{ width: '100%', paddingBottom: '4px', marginBottom: '4px' }}>
                    <InlineGrid columns="1fr auto">
                        <Text as="h5" variant="headingLg"> {offerName!= null || offerName!= undefined ? offerName : heading} {offerStatusBadge}</Text>
