...
function ButtonStyling({ open, handleOpen }) {
  return (
    <Card roundedAbove="sm">
      <BlockStack gap="200">
        <Button fullWidth disabled={open === 'button'} onClick={() => handleOpen('button')} ariaExpanded={open} ariaControls="basic-collapsible">
          Button styling
        </Button>
        <Collapsible open={open === 'button'} id="basic-collapsible" transition={{ duration: '500ms', timingFunction: 'ease-in-out' }} expandOnPrint>
          <BlockStack gap="300">
            <Divider />
...
function CanvasStyling({ open, handleOpen }) {
  ...
  return (
    <Card roundedAbove="sm">
      <BlockStack gap="400">
        <Button fullWidth disabled={open === componentName} onClick={() => handleOpen(componentName)} ariaExpanded={open} ariaControls="basic-collapsible">
          Canvas styling
        </Button>
        <Collapsible open={open === componentName} id="basic-collapsible" transition={{ duration: '500ms', timingFunction: 'ease-in-out' }} expandOnPrint>
          <BlockStack gap="300">
            <Divider />
