              ...
              <Checkbox
                label={
                  <Text as="p" variant="bodySm" fontWeight="bold">
                    Tag orders when offer is converted
                  </Text>
                }
                checked={value}
                onChange={onChange}
          ...
          <Controller
            ...
            render={({ field: { value, onChange } }) => (
              <Checkbox
                label={
                  <Text as="p" variant="bodySm" fontWeight="bold">
                    I use multi-language product handles
                  </Text>
                }
                checked={value}
                onChange={onChange}
          ...
          <Controller
            ...
            render={({ field: { value, onChange } }) => (
              <Select
                label={
                  <Text as="p" variant="bodySm" fontWeight="bold">
                    Where do you want to place the cart page discount message?
                  </Text>
                }
                options={[
                  {
                    label: 'Display popup on cart page',
                    value: PlacingCartPageDiscount.DisplayPopupOnCartPage,
                  },
                  {
                    label: 'Before HTML element',
                    value: PlacingCartPageDiscount.BeforeHtmlElement,
                  },
                  {
                    label: 'Start HTML element',
                    value: PlacingCartPageDiscount.StartHtmlElement,
                  },
                  {
                    label: 'End HTML element',
                    value: PlacingCartPageDiscount.EndHtmlElement,
                  },
                  {
                    label: 'After HTML element',
                    value: PlacingCartPageDiscount.AfterHtmlElement,
                  },
                ]}
                onChange={onChange}
                value={value}
                ...
                <TextField
                  label={
                    <Text as="p" variant="bodySm">
                      {' '}
                      CSS selector of the HTML element.
                    </Text>
                  }
                  value={value}
                  onChange={onChange}
