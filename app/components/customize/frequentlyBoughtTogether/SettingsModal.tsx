...
function AddAllCartAction() {
  ...
  const addAllCartActionOptions = [
    ...
    {
      label: 'Automatically click add to the cart button on the page',
          ...
          <Select
            label={
              <Text as="p" variant="bodySm" fontWeight="bold">
                Action after clicking add all to cart
              </Text>
            }
            value={value}
            onChange={onChange}
        ...
        <Controller
          ...
          render={({ field: { value, onChange } }) => (
            <TextField
              label={
                <Text as="p" variant="bodySm" fontWeight="bold">
                  CSS selector for add to cart button
                </Text>
              }
              value={value}
              onChange={onChange}
      ...
      render={({ field: { value, onChange } }) => (
        <Select
          ...
          options={[
            ...
            {
              label: 'Open product page in new tag',
              value: 'openProductPageInNewTab',
            },
          ]}
        />
      )}
    ...
    <Controller
      ...
      render={({ field: { value, onChange } }) => (
        <Select
          ...
          options={[
            {
              label: 'Apply discount when entire bundle is bought',
    ...
    <Controller
      ...
      render={({ field: { value, onChange } }) => (
        <Checkbox
          label={
            <Text as="p" variant="bodySm" fontWeight="bold">
              Disable Frequently bought together widget
            </Text>
          }
          checked={value}
          onChange={onChange}
