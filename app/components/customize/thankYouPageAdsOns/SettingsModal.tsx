            ...
            <BlockStack gap="300">
                ...
                <SelectModal
                    ...
                    options={[
                        ...
                        { label: "Open product page in new tab", value: "productPageNewTab" },
                    ]}
                />
                <SelectModal
                    property={"offerProductClickAction"}
                    ...
                    options={[
                        { label: "Create a new order in same tab", value: "productPageSameTab" },
                        { label: "Create a new order in new tab", value: "productPageNewTab" },
                    ]}
                />
            <CheckboxModal 
