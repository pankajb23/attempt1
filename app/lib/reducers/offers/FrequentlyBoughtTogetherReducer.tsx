...
export const selectSavedContent = (state: { frequentlyBoughtTogether: FrequentlyBoughtTogetherState }) =>
    state.frequentlyBoughtTogether.savedContent;

export const selectDraftContent = (state: { frequentlyBoughtTogether: FrequentlyBoughtTogetherState }) =>
    state.frequentlyBoughtTogether.draftContent;

export const selectHasUnsavedChanges = (state: { frequentlyBoughtTogether: FrequentlyBoughtTogetherState }) =>
